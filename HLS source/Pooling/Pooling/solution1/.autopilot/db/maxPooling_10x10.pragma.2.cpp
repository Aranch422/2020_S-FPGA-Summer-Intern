# 1 "Pooling/maxPooling_10x10.cpp"
# 1 "Pooling/maxPooling_10x10.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 152 "<built-in>" 3
# 1 "<command line>" 1
...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "Pooling/maxPooling_10x10.cpp" 2
void Max_Pooling_10x10(int ifmap[10][10],int (&result)[25]){_ssdm_SpecArrayDimSize(ifmap, 10);
