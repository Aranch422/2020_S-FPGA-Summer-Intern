# 1 "Pooling/maxPooling_28x28.cpp"
# 1 "Pooling/maxPooling_28x28.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 152 "<built-in>" 3
# 1 "<command line>" 1
...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "Pooling/maxPooling_28x28.cpp" 2
void Max_Pooling_28x28(int ifmap[28][28],int (&result)[784]){_ssdm_SpecArrayDimSize(ifmap, 28);
...
_ssdm_SpecArrayPartition( ifmap, 1, "COMPLETE", 0, "");
